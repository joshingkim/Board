...
<form action="/board/insert" method="post">
	...
	내용<br>
	<h6>0/100</h6>
	<textarea id="content" rows="10" name="content"></textarea><br>
		...
		$(".uploadedList").on("click", ".deleteitem", function() {
			...
			$.ajax({
				...
				success : function(result) {
					if(result == "SUCCESS"){
						clickdeleteitembtn.parent().parent().remove();
					}else{
						alert("삭제 실패");
					}
				}
